...
# coq_makefile Arith.v Arith_Lambda.v Bool.v Bool_Lambda.v Containers.v FJ_tactics.v Functors.v Lambda.v Mu.v Names.v NatCase.v PNames.v Polynomial.v Sum.v test_A.v test_AB.v test_ABL.v test_AL.v test_BL.v 
#
